...
const GUIDE_NL: GuideSection[] = [
  ...
  },
  {
    ...
    description: 'Hoe je de mobiele inspectie-wizard gebruikt bij in- en uitcheck.',
    content: [
      '── Wanneer gebruik je dit? ──',
      'De inspectie-wizard gebruik je op locatie (bij de caravan) om de staat van de caravan vast te leggen bij in- of uitcheck.',
      '',
      '── Stappen ──',
...
const GUIDE_EN: GuideSection[] = [
  ...
  },
  {
    ...
    paths: ['/admin/inspectie'],
    description: 'How to use the mobile inspection wizard at check-in and check-out.',
    content: [
      '── When to use this? ──',
      'Use the inspection wizard on-site (at the caravan) to record the condition of the caravan at check-in or check-out.',
      '',
      '── Steps ──',
