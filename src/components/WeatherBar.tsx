...
const icons = {
  ...
  rain: <CloudRain size={14} className="text-blue-200" />,
};
...
export default function WeatherBar() {
  ...
  return (
    <div className="bg-gradient-to-r from-primary via-blue-500 to-primary-light text-white text-xs sm:text-sm relative">
