...
function smartMatch(
  ...
  if (/inventaris|inbegrepen|wat zit|uitrusting|beddengoed|servies|kookgerei|handdoek|included|equipment|inventory|meenemen|paklijst/.test(lower)) {
    const inventoryAnswers = isNl ? [
      `Elke caravan is **compleet uitgerust**${name}:\n\n🍽️ Volledig servies & kookgerei\n🧹 Schoonmaakmiddelen\n🪥 Handdoeken & toiletpapier\n🪟 Rolgordijnen & horren\n⛺ Luifel (bij de meeste)\n\n🛏️ **Beddengoed** neem je zelf mee, of huur het bij ons voor **€70/week**.\n🚵 **Mountainbikes** zijn te huur voor €50/week per fiets.\n🧊 **Grotere koelkast** beschikbaar voor €40/week.\n\n💡 Je hoeft eigenlijk alleen je beddengoed en persoonlijke spullen mee te nemen!`,
      `De caravan is bijna helemaal compleet${name}! 🎒\n\n✅ **Koken**: pannen, borden, bestek, kookgerei\n✅ **Badkamer**: handdoeken, toiletpapier\n✅ **Comfort**: rolgordijnen, horren, luifel\n✅ **Schoonmaak**: bezem, vaatdoekjes, afwasmiddel\n\n🛏️ **Beddengoed** is het enige dat je zelf meeneemt — of huur het bij ons voor €70/week!\n\nOptie om **mountainbikes** (€50/week) en een **grotere koelkast** (€40/week) bij te boeken. 🚵\n\n🧳 Pak je koffer, neem je beddengoed mee en geniet! 😄`,
    ] : ['Every caravan comes **fully equipped** with tableware, cookware, cleaning supplies, towels, and more! Just bring your own bedding — or rent it from us for €70/week. Mountain bikes and a larger fridge are also available to rent.'];
    return {
          ...
          >
            ...
            <div className="bg-gradient-to-r from-primary to-primary-dark px-3 sm:px-4 py-2.5 sm:py-3 flex items-center gap-2.5 sm:gap-3 shrink-0 rounded-t-2xl">
              <div className="relative w-9 h-9 sm:w-10 sm:h-10 rounded-full overflow-hidden bg-white/20 flex items-center justify-center shrink-0">
                <Image src="https://u.cubeupload.com/laurensbos/12aCaravanverhuur2.png" alt="Caravanverhuur Spanje chatbot" width={28} height={28} className="object-contain sm:w-[30px] sm:h-[30px]" />
