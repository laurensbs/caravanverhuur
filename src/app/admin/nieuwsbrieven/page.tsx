  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
        {[
          { label: 'Totaal', value: totalCount, icon: Newspaper, color: 'text-[#58B09C]', bg: 'bg-[#58B09C]/10' },
              ...
              <div className="flex flex-col sm:flex-row sm:items-start justify-between gap-3">
                <div className="flex-1 min-w-0">
                  <div className="flex items-center gap-2 mb-1.5 flex-wrap">
                    <span className="text-xs font-medium px-2 py-0.5 rounded-full bg-[#f9f8f5] text-foreground border border-border">
                      {cat.emoji} {cat.label}
                    </span>
                    {isSent ? (
                ...
                <div className="flex items-center gap-1.5 shrink-0">
                  <button
                    ...
                    className="p-2 rounded-lg hover:bg-[#f9f8f5] transition cursor-pointer"
                    title="Voorbeeld"
                  >
                  ...
                  <div className="space-y-4">
                          ...
                          <button
                            ...
                            className={`px-3 py-2 rounded-lg text-sm font-medium transition cursor-pointer border ${
                              formCategory === c.value
                                ...
                                : 'bg-[#f9f8f5] border-border text-muted hover:text-foreground'
                            }`}
                          >
                            {c.emoji} {c.label}
                          </button>
                    ...
                    <div className="flex gap-3 pt-2">
                      <button
                        ...
                        className="flex-1 px-4 py-2.5 border border-border rounded-lg text-sm font-medium hover:bg-[#f9f8f5] transition cursor-pointer"
                        disabled={saving}
                      >
                        Annuleren
                      </button>
              ...
              {modal === 'preview' && selected && (
                <div className="p-6">
                  ...
                  <div className="border border-border rounded-xl overflow-hidden">
                    <div className="bg-[#f9f8f5] px-5 py-3 border-b border-border text-sm text-muted">
                    ...
                    <div className="p-6 bg-white">
                      <div className="text-center mb-4">
                        <span className="inline-block bg-[#f0faf6] text-[#386150] text-xs font-semibold px-3 py-1 rounded-full">
                      ...
                      {(selected.event_date || selected.event_location) && (
                        <div className="bg-[#f9f8f5] border border-border rounded-lg p-4 mb-4">
                          {selected.event_date && (
                      ...
                      <div className="bg-[#f0faf6] border border-[#d1f0e3] rounded-xl p-4 mb-4">
                      ...
                      <div className="text-center">
                        <span className="inline-block bg-[#386150] text-white px-6 py-3 rounded-xl font-semibold text-sm">
                          Bekijk caravans →
                        </span>
                      </div>
                    </div>
                ...
                <div className="p-6">
                  ...
                  {!sendResult ? (
                    <>
                      ...
                      <div className="bg-[#f9f8f5] border border-border rounded-xl p-4 mb-5">
