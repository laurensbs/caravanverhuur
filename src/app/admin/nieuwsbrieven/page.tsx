                          ...
                          <button
                            ...
                            className={`px-3 py-2 rounded-lg text-sm font-medium transition cursor-pointer ${
                              formCategory === c.value
                                ...
                                : 'bg-[#FAFAF9] text-muted hover:text-foreground'
                            }`}
                          >
                            {c.emoji} {c.label}
                          </button>
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                      <div>
                        ...
                        <input
                          ...
                          className="w-full px-4 py-2.5 rounded-lg focus:outline-none focus:ring-2 focus:ring-primary/20 cursor-pointer"
                        />
                      </div>
                      <div>
                        <label className="block text-sm font-medium text-foreground mb-1.5">
                          ...
                          {formPhotos.map((url, i) => (
                            <div key={i} className="flex items-center gap-2">
                              ...
                              <input
                                ...
                                className="flex-1 px-3 py-1.5 text-xs rounded-lg focus:outline-none focus:ring-2 focus:ring-primary/20"
                              />
                              <button
                                type="button"
