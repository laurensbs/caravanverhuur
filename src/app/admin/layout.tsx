...
const ONBOARDING_ADMIN_NL: OnboardingStep[] = [
  ...
  { title: 'Betalingen & Borg', desc: 'Volg betalingen en verwerk terugbetalingen via Holded. Bij vertrek gebruik je "Mobiel Inspecteren" om samen met de klant de borgchecklist af te lopen.', icon: '💳' },
...
const ONBOARDING_ADMIN_EN: OnboardingStep[] = [
  ...
  { title: 'Payments & Deposit', desc: 'Track payments and process refunds through Holded. At check-out, use "Mobile Inspect" to walk through the deposit checklist together with the customer.', icon: '💳' },
