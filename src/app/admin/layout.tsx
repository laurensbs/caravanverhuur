...
export default function AdminLayout({ children }: { children: ReactNode }) {
  ...
  if (!authenticated) {
    return (
      <div className="min-h-screen bg-gradient-to-br from-[#3D3522] via-[#386150] to-[#3D3522] flex items-center justify-center p-4 relative overflow-hidden">
        {/* Background pattern */}
  ...
  return (
    <div className="min-h-screen bg-surface-alt flex">
      ...
      {/* Sidebar */}
      <aside
        className={`fixed lg:static inset-y-0 left-0 z-50 w-64 bg-[#386150] text-white flex flex-col transform transition-transform duration-200 ${
