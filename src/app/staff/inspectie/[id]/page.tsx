...
type Step = 'intro' | 'inspect' | 'notes' | 'done';

const statusConfig = {
  goed: { icon: CheckCircle2, label: 'Goed', activeColor: 'bg-emerald-500 text-white ring-emerald-500/30' },
  beschadigd: { icon: AlertTriangle, label: 'Beschadigd', activeColor: 'bg-amber-500 text-white ring-amber-500/30' },
  ontbreekt: { icon: XCircle, label: 'Ontbreekt', activeColor: 'bg-red-500 text-white ring-red-500/30' },
  nvt: { icon: Minus, label: 'N.v.t.', activeColor: 'bg-gray-400 text-white ring-gray-400/30' },
};

export default function StaffInspectiePage({ params }: { params: Promise<{ id: string }> }) {
  const { id } = use(params);
    ...
    return (
      <div className="fixed inset-0 z-[100] overflow-auto bg-[#FAFAF9] flex items-center justify-center p-4">
        <div className="bg-white rounded-2xl p-8 max-w-sm w-full text-center">
          ...
          <button onClick={() => router.back()} className="text-emerald-600 text-sm font-semibold cursor-pointer">
            ← Terug
          </button>
        </div>
      </div>
      ...
      <div className="fixed inset-0 z-[100] overflow-auto bg-[#FAFAF9]">
        <div className="bg-emerald-700 text-white">
          <div className="max-w-lg mx-auto px-5 py-8">
            <button onClick={() => router.back()} className="flex items-center gap-1 text-white/70 text-sm mb-6 hover:text-white transition cursor-pointer">
        ...
        <div className="max-w-lg mx-auto px-5 -mt-4">
          ...
          <div className="bg-white rounded-2xl p-5 shadow-sm mb-4">
            ...
            <input
              ...
              className="w-full px-4 py-3 bg-[#FAFAF9] rounded-xl text-sm focus:outline-none focus:ring-2 focus:ring-emerald-500/20"
            />
          </div>
          ...
          <button
            ...
            className="w-full py-4 bg-emerald-600 text-white rounded-2xl text-base font-bold shadow-lg transition-transform active:scale-[0.98] cursor-pointer flex items-center justify-center gap-2"
          >
            Start inspectie
      ...
      <div className="fixed inset-0 z-[100] overflow-auto bg-[#FAFAF9] flex flex-col">
        <div className="bg-white sticky top-0 z-10 shadow-sm">
          <div className="max-w-lg mx-auto px-5 py-3">
            <div className="flex items-center justify-between mb-2">
              ...
              <button
                onClick={goNext}
                className="flex items-center gap-1 text-emerald-600 text-sm font-semibold cursor-pointer"
              >
                ...
                {activeNote === currentItem.globalIndex ? (
                  <div className="bg-white rounded-2xl p-4 shadow-sm">
                    ...
                    <textarea
                      ...
                      rows={2}
                      autoFocus
                      className="w-full px-3 py-2 bg-[#FAFAF9] rounded-xl text-sm focus:outline-none focus:ring-2 focus:ring-emerald-500/20 resize-none"
                    />
                  </div>
                ) : (
                  <button
                    onClick={() => setActiveNote(currentItem.globalIndex)}
        ...
        <div className="sticky bottom-0 bg-white/90 backdrop-blur-md px-5 py-3 max-w-lg mx-auto w-full">
          ...
          <div className="h-1 bg-gray-100 rounded-full overflow-hidden">
            <div className="h-full rounded-full transition-all bg-emerald-500" style={{ width: `${progressPct}%` }} />
          </div>
        </div>
      </div>
    );
        ...
        <div className="max-w-lg mx-auto px-5 py-6 space-y-5">
          ...
          <div className="bg-white rounded-2xl p-5 shadow-sm">
            ...
            <textarea
              ...
              rows={3}
              className="w-full px-4 py-3 bg-[#FAFAF9] rounded-xl text-sm focus:outline-none focus:ring-2 focus:ring-emerald-500/20 resize-none"
            />
          </div>
          ...
          <div className="space-y-3">
            <button
              ...
              disabled={saving}
              className="w-full py-4 bg-emerald-600 text-white rounded-2xl text-base font-bold shadow-lg transition-all active:scale-[0.98] cursor-pointer disabled:opacity-50 flex items-center justify-center gap-2"
            >
    ...
    return (
      <div className="fixed inset-0 z-[100] overflow-auto bg-[#FAFAF9] flex items-center justify-center p-5">
        ...
        >
          ...
          <button
            onClick={() => router.push('/staff/borg')}
            className="w-full py-3 bg-emerald-600 text-white rounded-xl text-sm font-bold cursor-pointer transition-transform active:scale-[0.98]"
          >
