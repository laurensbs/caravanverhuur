...
const statusColors: Record<string, string> = {
  ...
  'IN_BEHANDELING': 'bg-amber-50 text-amber-600',
  'AFGEROND': 'bg-emerald-50 text-emerald-700',
  'KLANT_AKKOORD': 'bg-emerald-100 text-emerald-800',
  'KLANT_BEZWAAR': 'bg-red-50 text-red-600',
};
...
export default function StaffBorgPage() {
    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-2 sm:grid-cols-4 gap-3">
        {[
          ...
          { label: 'Open', value: stats.open, color: 'bg-emerald-50 text-emerald-600' },
          { label: 'In behandeling', value: stats.inProgress, color: 'bg-amber-50 text-amber-600' },
          { label: 'Afgerond', value: stats.done, color: 'bg-emerald-50 text-emerald-700' },
        ].map(s => (
          ...
          >
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
              <div>
                ...
                <select
                  ...
                  className="w-full px-3 py-2.5 rounded-lg text-sm focus:outline-none focus:border-emerald-500"
                  required
                >
            ...
            <div className="flex gap-3 mt-4">
              <button
                type="submit"
                disabled={creating}
                className="flex items-center gap-2 px-4 py-2 bg-emerald-600 text-white rounded-lg text-sm font-semibold hover:bg-emerald-700 transition-colors cursor-pointer disabled:opacity-50"
              >
                    ...
                    <div className="min-w-0">
                      <div className="flex items-center gap-2 flex-wrap">
                        ...
                        <span className={`px-2 py-0.5 rounded-full text-[10px] font-semibold ${
                          checklist.type === 'INCHECKEN' ? 'bg-blue-50 text-blue-600' : 'bg-purple-50 text-purple-600'
                        }`}>
                      ...
                      <div className="p-4 space-y-5">
                        ...
                        <div>
                          ...
                          <input
                            ...
                            className="w-full max-w-xs px-3 py-2 rounded-lg text-sm focus:outline-none focus:border-emerald-500"
                            placeholder="Naam medewerker"
                                  ...
                                  return (
                                    <div key={item.item} className="flex flex-col sm:flex-row sm:items-center gap-2 bg-surface rounded-lg p-2.5">
                                        ...
                                        {(['goed', 'beschadigd', 'ontbreekt', 'nvt'] as const).map(st => (
                                          <button
                                            ...
                                            className={`px-2 py-1 rounded text-[10px] font-semibold transition-colors cursor-pointer ${
                                              item.status === st
                                                ? st === 'goed' ? 'bg-emerald-500 text-white'
                                      ...
                                      <input
                                        ...
                                        disabled={!isEditable}
                                        className="flex-1 px-2 py-1 rounded text-xs focus:outline-none focus:border-emerald-500 disabled:bg-surface-alt"
                                      />
                                      {isEditable && (
                                        <button
                                          onClick={() => handleRemoveItem(checklist.id, globalIdx)}
                                          className="shrink-0 p-1 text-muted hover:text-red-500 transition-colors cursor-pointer"
                            ...
                            {addingItemTo === checklist.id ? (
                              <div className="flex flex-col sm:flex-row gap-2">
                                <select
                                  ...
                                  className="px-2 py-1.5 rounded text-xs focus:outline-none focus:border-emerald-500 sm:w-40"
                                >
                                ...
                                <input
                                  ...
                                  className="flex-1 px-2 py-1.5 rounded text-xs focus:outline-none focus:border-emerald-500"
                                ...
                                <div className="flex gap-1">
                                  <button
                                    ...
                                    className="px-3 py-1.5 bg-emerald-600 text-white rounded text-xs font-semibold disabled:opacity-50 cursor-pointer"
                                  >
                                    Toevoegen
                                  </button>
                                  <button
                              ...
                              <button
                                ...
                                className="flex items-center gap-2 text-xs text-emerald-600 font-medium cursor-pointer hover:text-emerald-700 transition-colors"
                              >
                        ...
                        <div>
                          ...
                          <textarea
                            ...
                            rows={3}
                            className="w-full px-3 py-2 rounded-lg text-sm focus:outline-none focus:border-emerald-500 disabled:bg-surface-alt"
                        ...
                        <div className="flex flex-wrap gap-3 pt-2">
                          ...
                          >
                            {copiedToken === checklist.token ? <CheckCircle2 size={14} className="text-emerald-500" /> : <Copy size={14} />}
                          ...
                          {checklist.status !== 'AFGEROND' && checklist.status !== 'KLANT_AKKOORD' && (
                            <a
                              href={`/staff/inspectie/${checklist.id}`}
