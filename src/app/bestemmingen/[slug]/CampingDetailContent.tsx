      ...
      <section className="relative h-[50vh] sm:h-[60vh] overflow-hidden">
        ...
        <div className="absolute bottom-0 left-0 right-0 p-4 sm:p-8">
          <div className="max-w-6xl mx-auto">
            ...
            <h1 className="text-3xl sm:text-5xl font-bold text-white mb-3">{camping.name}</h1>
      ...
      <section className="max-w-6xl mx-auto px-4 py-10 sm:py-14">
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 lg:gap-12">
          ...
          <div className="lg:col-span-2 space-y-10">
            {/* Description */}
            <div>
              <h2 className="text-2xl font-bold text-gray-900 mb-4">{t('destinations.aboutCamping')}</h2>
            ...
            {camping.facilities && camping.facilities.length > 0 && (
              <div>
                <h2 className="text-2xl font-bold text-gray-900 mb-4">{t('destinations.facilitiesTitle')}</h2>
            ...
            {camping.photos && camping.photos.length > 1 && (
              <div>
                <h2 className="text-2xl font-bold text-gray-900 mb-4">{t('destinations.photosTitle')}</h2>
