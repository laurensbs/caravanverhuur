...
export default function OverOnsPage() {
  return (
    <>
      ...
      {/* CTA */}
      <section className="py-20 bg-gradient-to-r from-primary-dark via-primary to-primary-dark text-white">
        <div className="max-w-4xl mx-auto px-4 text-center">
          ...
          <Link
            href="/boeken"
            className="inline-flex items-center gap-2 px-8 py-4 bg-accent hover:bg-accent-dark text-white font-semibold rounded-full shadow-lg hover:shadow-xl transition-all text-lg"
          >
            Direct boeken
            <ArrowRight size={20} />
          </Link>
