          ...
          <motion.div initial={{ scale: 0.8, opacity: 0 }} animate={{ scale: 1, opacity: 1 }} transition={{ type: 'spring', damping: 20 }} className="text-center">
            ...
            <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.4 }} className="bg-white rounded-2xl p-6 shadow-lg text-left mb-6">
              ...
              <div className="grid grid-cols-2 gap-3 text-sm">
                ...
                <div className="bg-surface rounded-xl p-3"><p className="text-muted text-xs mb-0.5">{t('booking.personsLabel')}</p><p className="font-semibold">{adults} {t('booking.personsAdults')}{children > 0 ? ` + ${children} ${t('booking.child')}` : ''}</p></div>
              </div>
              <div className="mt-4 pt-4 space-y-2">
                ...
                <div className="bg-primary/5 rounded-lg p-3 mt-2">
                  <div className="flex justify-between items-center">
                    <span className="text-xs font-bold text-primary uppercase tracking-wider">{t('booking.payNowLabel')}</span>
                    <span className="font-bold text-primary">&euro;{deposit25}</span>
                  </div>
                </div>
                <div className="bg-amber-50 rounded-lg p-3 space-y-1">
                  <p className="text-xs font-bold text-amber-700 uppercase tracking-wider mb-1">{t('booking.payOnCampingLabel')}</p>
                        ...
                        <div className="grid grid-cols-2 gap-4 sm:gap-5">
                          <div>
                            ...
                            <div className="flex items-center gap-2 sm:gap-3 mt-2">
                              <button onClick={() => setAdults(Math.max(1, adults - 1))} disabled={adults <= 1} className="w-8 h-8 sm:w-10 sm:h-10 rounded-full border-2 flex items-center justify-center text-foreground-light transition-colors cursor-pointer disabled:opacity-30">
                                <Minus size={14} />
                              </button>
                              <span className="text-lg sm:text-xl font-bold text-foreground w-6 sm:w-8 text-center">{adults}</span>
                              <button onClick={() => setAdults(Math.min(4 - children, adults + 1))} disabled={adults + children >= 4} className="w-8 h-8 sm:w-10 sm:h-10 rounded-full border-2 flex items-center justify-center text-foreground-light transition-colors cursor-pointer disabled:opacity-30">
                                <Plus size={14} />
                              </button>
                            </div>
                          </div>
                          <div>
                            ...
                            <div className="flex items-center gap-2 sm:gap-3 mt-2">
                              <button onClick={() => setChildren(Math.max(0, children - 1))} disabled={children <= 0} className="w-8 h-8 sm:w-10 sm:h-10 rounded-full border-2 flex items-center justify-center text-foreground-light transition-colors cursor-pointer disabled:opacity-30">
                                <Minus size={14} />
                              </button>
                              <span className="text-lg sm:text-xl font-bold text-foreground w-6 sm:w-8 text-center">{children}</span>
                              <button onClick={() => setChildren(Math.min(4 - adults, children + 1))} disabled={adults + children >= 4} className="w-8 h-8 sm:w-10 sm:h-10 rounded-full border-2 flex items-center justify-center text-foreground-light transition-colors cursor-pointer disabled:opacity-30">
                                <Plus size={14} />
                              </button>
                            </div>
                          </div>
                        ...
                        <div className="p-6 space-y-4">
                          <div className="grid grid-cols-2 sm:grid-cols-4 gap-3">
                            ...
                            <div className="bg-surface rounded-xl p-3">
                              ...
                              <p className="font-semibold text-sm">{adults} {t('booking.personsAdults')}{children > 0 ? ` + ${children} ${t('booking.child')}` : ''}</p>
                            </div>
                          </div>
                          ...
                          <div className="mt-2 space-y-3">
                            ...
                            <div className="rounded-xl border-2 border-primary/20 bg-primary/5 p-4">
                              <div className="flex items-center gap-2 mb-2">
                                ...
                                <p className="text-xs font-bold uppercase tracking-wider text-primary">{t('booking.payNowLabel')}</p>
                              </div>
                              <div className="flex justify-between items-center">
                                <span className="text-sm font-semibold text-foreground">{t('booking.deposit25Label')}</span>
                                <span className="text-xl font-bold text-primary">&euro;{deposit25}</span>
                              </div>
                            </div>
                            ...
                            <div className="rounded-xl border border-amber-200 bg-amber-50/60 p-4">
                              <div className="flex items-center gap-2 mb-2">
                                ...
                                <p className="text-xs font-bold uppercase tracking-wider text-amber-700">{t('booking.payOnCampingLabel')}</p>
                              </div>
                              <div className="space-y-1.5">
                                <div className="flex justify-between text-sm"><span className="text-foreground">{t('booking.restOnCamping')}</span><span className="font-semibold">&euro;{restAmount}</span></div>
                                <div className="flex justify-between text-sm"><span className="text-foreground">{t('booking.borgOnCamping')}</span><span className="font-semibold">&euro;{totalBorg}</span></div>
                              </div>
                              <p className="text-[11px] text-amber-600 mt-2 flex items-center gap-1">💳 {t('booking.paymentMethodCamping')}</p>
                            </div>
                          </div>
                    ...
                    {totalPrice > 0 && (
                      <div className="pt-2.5 mt-1 border-t border-gray-100 space-y-2">
                        ...
                        <div className="bg-primary/5 rounded-lg px-2.5 py-2">
                          <div className="flex justify-between items-center">
                            <span className="text-[11px] font-bold text-primary uppercase tracking-wider">{t('booking.payNowLabel')}</span>
                            <span className="text-sm font-bold text-primary">&euro;{deposit25}</span>
                          </div>
                        </div>
                        {/* At campsite */}
                        <div className="bg-amber-50 rounded-lg px-2.5 py-2 space-y-0.5">
                          <p className="text-[11px] font-bold text-amber-700 uppercase tracking-wider mb-1">{t('booking.payOnCampingLabel')}</p>
                          <div className="flex justify-between text-xs">
                            <span className="text-foreground-light">{t('booking.restOnCamping')}</span>
                            <span className="font-medium">&euro;{restAmount}</span>
                          </div>
                          <div className="flex justify-between text-xs">
                            <span className="text-foreground-light">{t('booking.borgOnCamping')}</span>
                            <span className="font-medium">&euro;{totalBorg}</span>
                          </div>
                        </div>
                      </div>
                    )}
