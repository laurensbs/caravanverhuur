    ...
    <section className="min-h-[70vh] flex items-center justify-center px-4 py-16">
      ...
      >
        ...
        <div className="flex flex-col sm:flex-row gap-3 justify-center">
          ...
          >
            <Home size={18} />
            {t('notFound.toHome')} </Link> <Link href="/bestemmingen" className="inline-flex items-center justify-center gap-2 px-6 py-3 border-primary text-primary font-semibold rounded-full transition-all" > {t('nav.destinations')}
            <ArrowRight size={18} />
          </Link>
        </div>
      </motion.div>
